...
model = 'ori_model.hdf5';
info = h5info(model);

conv1_kernel_32bit = h5read(model,'/conv2d/conv2d/kernel:0');
conv1_bias_32bit = h5read(model,'/conv2d/conv2d/bias:0');
...
conv2_kernel_32bit = h5read(model,'/conv2d_1/conv2d_1/kernel:0');
conv2_bias_32bit = h5read(model,'/conv2d_1/conv2d_1/bias:0');
...
dense1_kernel_32bit = h5read(model,'/dense/dense/kernel:0');
dense1_bias_32bit = h5read(model,'/dense/dense/bias:0');
